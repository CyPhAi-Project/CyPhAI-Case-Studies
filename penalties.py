...
def lunch_time(meal_space, P, s1) -> float:
    ...
    if (s1 > 0) and P["lunch_time"] < P["breakfast_time"] + meal_space["lunch_d_with_snack1"][0]:
        pen_lunch_time = BASE_PENALTY + (P["breakfast_time"] + meal_space["lunch_d_with_snack1"][0]) - P["lunch_time"]
    elif (s1 > 0) and P["lunch_time"] > P["breakfast_time"] + meal_space["lunch_d_with_snack1"][1]:
        pen_lunch_time = BASE_PENALTY + P["lunch_time"] - (P["breakfast_time"] + meal_space["lunch_d_with_snack1"][1])
    elif (s1 == 0) and P["lunch_time"] < P["breakfast_time"] + meal_space["lunch_d_no_snack1"][0]:
        pen_lunch_time = BASE_PENALTY + (P["breakfast_time"] + meal_space["lunch_d_no_snack1"][0]) - P["lunch_time"]
    elif (s1 == 0) and P["lunch_time"] > P["breakfast_time"] + meal_space["lunch_d_no_snack1"][1]:
...
def dinner_time(meal_space, P, s3) -> Tuple[float, float]:
    ...
    if s3 > 0:
        if P["dinner_time"] > meal_space["dinner_time_with_snack3"][1]:
            pen_dinner_time_h = BASE_PENALTY + P["dinner_time"] - meal_space["dinner_time_with_snack3"][1]
        else:
            pen_dinner_time_h = 0

        if P["dinner_time"] < P["lunch_time"] + meal_space["dinner_d_with_snack3"][0]:
            pen_dinner_time_d = BASE_PENALTY + (P["lunch_time"] + meal_space["dinner_d_with_snack3"][0]) - P[
                "dinner_time"]
        elif P["dinner_time"] > P["lunch_time"] + meal_space["dinner_d_with_snack3"][1]:
        ...
        if P["dinner_time"] < meal_space["dinner_time_no_snack3"][0]:
            pen_dinner_time_h = BASE_PENALTY + meal_space["dinner_time_no_snack3"][0] - P["dinner_time"]
        else:
            pen_dinner_time_h = 0

        if P["dinner_time"] < P["lunch_time"] + meal_space["dinner_d_no_snack3"][0]:
            pen_dinner_time_d = BASE_PENALTY + (P["lunch_time"] + meal_space["dinner_d_no_snack3"][0]) - P[
                "dinner_time"]
        elif P["dinner_time"] > P["lunch_time"] + meal_space["dinner_d_no_snack3"][1]:
            pen_dinner_time_d = BASE_PENALTY + P["dinner_time"] - (
