...
from symbolic_timed_automata.simglucose.utils import evaluate_robustness, get_random_meal_plan, \
    simglucose_isotropic_sampling
...
if __name__ == "__main__":
    print(f"Falsification with random isotropic sampling")
    ...
    if args.output is not None:
        ...
        output_path = "../../experiments/output/simglucose/falsification/isotropic"
    ...
    for run_idx, run_seed in enumerate(runs_seeds):
        ...
        random_meal_plans = simglucose_isotropic_sampling(
            n_signals=n_meal_plans,
            dist_factor=args.dist_factor,
            for_falsification=True)
